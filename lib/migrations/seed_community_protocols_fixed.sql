...
-- Uses your actual user ID (Temujin)

-- Recovery & Healing Stack
INSERT INTO protocol_templates (user_id, name, description, peptide_name, dose, route, frequency, duration_weeks, usage_count, is_public, created_at)
VALUES 
  ('b1a33325-80ef-4426-8873-b06794c5d828', 
